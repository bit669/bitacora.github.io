...
//       currentValues !== prevFecha
//     ) {
//       // Añadir nueva página solo si los valores son diferentes y no es la primera página
//       if (index > 0) {
//         pdf.addPage();
//         yPos = 20;
//       }
...
//   // Comprobar si hay elementos en el arreglo bases
//   if (bases.length > 0) {
//     // Variable para indicar si es la primera imagen
//     let firstImage = true;
...
//       // Cambiar el valor de 'firstImage'
//       firstImage = false;
//     }
//   }
...
//           const iWidth = img.naturalWidth;
//           const iHeight = img.naturalHeight;
//           const width = iWidth / 4;
//           const height = iHeight / 4;
